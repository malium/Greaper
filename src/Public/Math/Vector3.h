...
template<class T>
NODISCARD INLINE constexpr greaper::math::Vector3Signed<T> ClampZeroToOne<greaper::math::Vector3Signed<T>>(const greaper::math::Vector3Signed<T> a)noexcept
{
	return a.GetClampledAxes(T(0), T(1));
}

template<class T>
NODISCARD INLINE constexpr greaper::math::Vector3Signed<T> ClampNegOneToOne<greaper::math::Vector3Signed<T>>(const greaper::math::Vector3Signed<T> a)noexcept
{
	return a.GetClampledAxes(T(-1), T(1));
}

template<class T>
NODISCARD INLINE constexpr greaper::math::Vector3Unsigned<T> ClampZeroToOne<greaper::math::Vector3Unsigned<T>>(const greaper::math::Vector3Unsigned<T> a)noexcept
{
	return a.GetClampledAxes(T(0), T(1));
}
