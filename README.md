...
Greaper currently supports Windows using 64bits, 32bits (needs testing), and Linux(needs testing) based OS. Mac and another Apple platforms won't be supported.
